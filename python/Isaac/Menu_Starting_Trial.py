...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.sidebar_button_1 = customtkinter.CTkButton(self.sidebar_frame, command= self.sidebar_button_event, text="Training")
        self.sidebar_button_1.grid(row=1, column=0, padx=20, pady=10)
        self.sidebar_button_2 = customtkinter.CTkButton(self.sidebar_frame, command=self.sidebar_button_event, text="Testing")
        ...
        self.main_button_2 = customtkinter.CTkButton(master=self, fg_color="transparent", border_width=2, text="Exit", text_color=("gray10", "#DCE4EE"))
    ...
    # defines 
    def open_input_dialog_event(self):  # how to make nzl and asl seperate?
